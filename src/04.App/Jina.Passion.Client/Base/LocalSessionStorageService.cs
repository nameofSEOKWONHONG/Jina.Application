...
/// 테스트 및 공통 저장
/// </summary>
public class LocalSessionStorageService : ISessionStorageService, IStorageService
{
    private readonly ILocalStorageService _service;
    public LocalSessionStorageService(ILocalStorageService localStorageService)
    {
